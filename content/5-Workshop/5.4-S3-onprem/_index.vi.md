...
![Validation metrics Logistic Regression — ROC-AUC 0,863949; F1 0,747583; recall 0,789116; precision 0,710204](/fcaj-hcmut-template/images/5-Workshop/W3-02-lr-metrics.png)

![Validation metrics XGBoost mặc định — ROC-AUC 0,854283; F1 0,749749; recall 0,845805; precision 0,673285](/fcaj-hcmut-template/images/5-Workshop/W3-04-xgb-metrics.png)
...
![Model Registry với version 1 và 2 Approved, version 3 PendingManualApproval](/fcaj-hcmut-template/images/5-Workshop/W5-01-model-versions.png)
...
![Real-time endpoint heart-risk-endpoint ở trạng thái InService](/fcaj-hcmut-template/images/5-Workshop/W6-01a-endpoint-inservice.png)
...
![Confusion matrix và ROC-AUC/F1/recall/precision trên tập test của Logistic Regression được chọn](/fcaj-hcmut-template/images/5-Workshop/W5-02-evaluation-metrics-and-confusion-matrix.png)
...
![Routes API Gateway — GET /health và POST /predict](/fcaj-hcmut-template/images/5-Workshop/W6-07-api-routes.png)
...
![POST /predict happy path trả 200 với prediction và risk_probability](/fcaj-hcmut-template/images/5-Workshop/W6-09-predict-200.png)

- `POST /predict` với thiếu trường → `400 Bad Request`. Lambda validator chặn trước khi request tới SageMaker.

![POST /predict trả 400 khi thiếu trường bắt buộc](/fcaj-hcmut-template/images/5-Workshop/W6-10-predict-400.png)
