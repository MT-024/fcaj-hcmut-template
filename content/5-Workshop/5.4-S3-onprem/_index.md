...
![Logistic Regression validation metrics — ROC-AUC 0.863949, F1 0.747583, recall 0.789116, precision 0.710204](/fcaj-hcmut-template/images/5-Workshop/W3-02-lr-metrics.png)

![XGBoost default validation metrics — ROC-AUC 0.854283, F1 0.749749, recall 0.845805, precision 0.673285](/fcaj-hcmut-template/images/5-Workshop/W3-04-xgb-metrics.png)
...
![Model Registry with versions 1 and 2 Approved and version 3 PendingManualApproval](/fcaj-hcmut-template/images/5-Workshop/W5-01-model-versions.png)
...
![Real-time endpoint heart-risk-endpoint in InService state](/fcaj-hcmut-template/images/5-Workshop/W6-01a-endpoint-inservice.png)
...
![Confusion matrix and ROC-AUC/F1/recall/precision on the test split for the chosen Logistic Regression model](/fcaj-hcmut-template/images/5-Workshop/W5-02-evaluation-metrics-and-confusion-matrix.png)
...
![API Gateway routes — GET /health and POST /predict](/fcaj-hcmut-template/images/5-Workshop/W6-07-api-routes.png)
...
![POST /predict happy path returns 200 with prediction and risk_probability](/fcaj-hcmut-template/images/5-Workshop/W6-09-predict-200.png)

- `POST /predict` with a missing field → `400 Bad Request`. The Lambda validator catches this before it ever reaches SageMaker.

![POST /predict returns 400 when a required field is missing](/fcaj-hcmut-template/images/5-Workshop/W6-10-predict-400.png)
